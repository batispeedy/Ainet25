...
<div class="max-w-7xl mx-auto bg-white rounded shadow p-6">
    ...
    <table class="w-full table-auto border-collapse">
        ...
        @forelse($users as $u)
            <tr class="{{ $u->trashed() ? 'bg-red-50' : '' }}">
                <td class="border px-4 py-2 text-center">
                    <img
                        src="{{ asset('storage/users/' . ($u->photo ?? 'anonymous.png')) }}"
                        alt="Foto de {{ $u->name }}"
                ...
                <td class="border px-4 py-2 space-x-2">
                    <a
                        href="{{ route('settings.users.edit', $u) }}"
        ...
        @empty
            <tr>
                <td colspan="6" class="border px-4 py-2 text-center italic text-gray-500">
                    Não há utilizadores para mostrar.
                </td>
            </tr>
        @endforelse
        </tbody>
